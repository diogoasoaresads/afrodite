...
import { getProductById, getRelatedProducts, categories } from '@/lib/products'
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mt-8">
              ...
              <button
                className="border border-dark-600 hover:border-gold-500 text-dark-300 hover:text-gold-400 p-4 transition-colors"
            ...
            <div className="mt-10 space-y-4 border-t border-gold-500/10 pt-8">
              {[
                ...
                { icon: <RefreshCcw size={16} className="text-gold-400" />, text: 'Troca grátis em até 30 dias' },
              ].map(item => (
